...
public class ElasticsearchTweetController {
    ...
    public static class AddTweetsTask extends AsyncTask<NormalTweet, Void, Void> { //static means youll only have one instance of the class

        @Override
        protected Void doInBackground(NormalTweet... tweets) { //... IS FOR MULTIPLE ARGUMENTS
            verifySettings();
